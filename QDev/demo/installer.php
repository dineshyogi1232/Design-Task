...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20220305_qdevtechnolab_a2a4ef7e5018e6089737_20220305120952_archive.zip';
    const ARCHIVE_SIZE       = '184223759';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'a2a4ef7-05120952';
    const SECONDARY_PACKAGE_HASH = '9b8ba43-05120952';
